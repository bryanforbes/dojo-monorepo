...
import request, { providerRegistry, Response, Headers, RequestOptions, UploadObservableTask } from '@dojo/core/request';
import ResponseClass from '@dojo/core/request/Response';
