...
import { default as nodeRequest, NodeResponse } from '@dojo/core/request/providers/node';
...
const blobFileSize = fs.statSync(path.resolve(__dirname, '../../../../../../../packages/node_modules/@dojo/tests/core/support/data/blob.gif')).size;
