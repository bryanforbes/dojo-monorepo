...
import { queueAnimationTask, queueMicroTask, queueTask } from '@dojo/shim/support/queue';
...
self.addEventListener('message', function (event) {
	if(event.data.baseUrl) {
		...
		importScripts(baseUrl + '/_build/node_modules/@dojo/shim/util/amd.js', baseUrl + '/node_modules/@dojo/loader/loader.js');

		require.config(shimAmdDependencies({
			baseUrl: baseUrl
		}));

		require(['@dojo/shim/support/queue'], function (queue) {
