	...
	tests: {
		...
		'has loader tests': {
			...
			'load test resourceId provided'() {
				...
				hasAdd('abc', true);
				const resourceId = 'has!abc?intern:intern!object';
		...
		'static has features': {
			'staticFeatures object'() {
				...
				import('@dojo/has/has').then(dfd.callback((mod: { default: typeof has }) => {
					const h = mod.default;
			...
			'can override run-time defined features'() {
				...
				// tslint:disable-next-line
				import('@dojo/has/has').then(dfd.callback((mod: { default: typeof has, add: typeof hasAdd }) => {
					const h = mod.default;
					const hAdd = mod.add;
